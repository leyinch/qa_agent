...
2. **Verify tables were created**:
   ```sql
   SELECT table_name 
   FROM `your-project-id.config.INFORMATION_SCHEMA.TABLES`;
   ```
...
**Example:**
```sql
SELECT * FROM `your-project-id.config.scd_validation_config` 
...
- **Location**: `your-project-id.qa_results.scd_test_history`
...
### View Test History
```sql
SELECT * FROM `your-project-id.qa_results.scd_test_history`
